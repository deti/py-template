...
from {{cookiecutter.py_package}}.cli.show_settings import main
...
def test_show_settings_main_function():
    ...
    assert settings_data["app_name"] == "{{cookiecutter.py_package}}"
...
def test_show_settings_cli_module_execution():
    ...
    proc = subprocess.run(
        [sys.executable, "-m", "{{cookiecutter.py_package}}.cli.show_settings"],
        capture_output=True,
        text=True,
        env=env,
        check=True,
...
def test_show_settings_script_entry_point():
    ...
    proc = subprocess.run(
        [
            ...
            "from {{cookiecutter.py_package}}.cli.show_settings import main; main()",
        ],
        capture_output=True,
        text=True,
        env=env,
